...
class Food {
  ...
  toMeal(food) {
    return `
      <tr class="meal-row">
        <div class="grid-item meal-data-id">${food.id}</div>
        <div class="grid-item meal-data-name meal">${food.name}</div>
        <div class="grid-item meal-data-calorie">${food.calories}</div>
        <div class="grid-item meal-data-delete"><img src='images/cancel-button.svg' class='food-delete delete-icon'></div>
      </tr>
    `
  }
