...
/***/ (function(module, exports, __webpack_require__) {
	...
	const foodEvents = __webpack_require__(1);
	const diaryEvents = __webpack_require__(7);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	const host = __webpack_require__(5).host;
	...
	class Food {
	  ...
	  static allEntriesToHTML() {
	    this.getAllFood().then(Food.returnFoods).then(Food.addFoodstoList).fail(Helper.errorHandler);
	  }
	  ...
	  static postNewFood(foodName, foodCalorie) {
	    ...
	    $.post(`${host}/foods`, data).then(Food.returnFoodObject).then(Food.prependFoodToList).then(HTMLHelper.resetForm()).fail(Helper.errorHandler);
	  }
	  ...
	  static filterFoodList() {
	    ...
	    }).then(Food.returnFoods).then(HTMLHelper.foodListReset("food")).then(Food.addFoodstoList).fail(Helper.errorHandler);
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	class HTMLHelper {
	  ...
	  static assignState(previousState, state) {
	    $('.diary-data-calorie-heading').removeClass(`${previousState}`).addClass(`${state}`);
	  }
	}
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  host: 'https://qs-api-nc-sl.herokuapp.com/api/v1'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	let $ = __webpack_require__(2);
	const Diary = __webpack_require__(8);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	class Diary {
	  static allEntriesToHTML() {
	    Food.getAllFood().then(Food.returnFoods).then(Diary.addFoodstoList).fail(Helper.errorHandler);
	  }
	  ...
	  static filterFoodList() {
	    ...
	    Food.getAllFood().then(function (data) {
	      return Helper.filterFoodsApi(data, word);
	    }).then(Food.returnFoods).then(HTMLHelper.foodListReset("diary")).then(Diary.addFoodstoList).fail(Helper.errorHandler);
	  }

	  static allMealsToHTML() {
	    Diary.getMeals().then(Diary.createMealsTables).then(Diary.populateGoalTable);
	  }
